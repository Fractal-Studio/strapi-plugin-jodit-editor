...
const index = require("./index-DomylXe6.js");
...
`;
const AiModalOverlay = styled__default.default.div`
  position: fixed;
  inset: 0;
  z-index: 10000;
  display: flex;
...
`;
const AiModalPanel = styled__default.default.div`
  width: min(960px, 100%);
...
`;
const AiModalTitle = styled__default.default.h2`
  margin: 0;
  font-size: 20px;
  font-weight: 700;
`;
const AiModalText = styled__default.default.div`
  font-size: 14px;
  line-height: 1.5;
`;
const AiModalActions = styled__default.default.div`
  display: flex;
  justify-content: flex-end;
  gap: 8px;
`;
const AiModalButton = styled__default.default.button`
  min-height: 36px;
  padding: 0 14px;
...
`;
const AiEditorShell = styled__default.default.div`
  min-height: 360px;
  border: 1px solid ${({ theme }) => theme.colors.neutral200};
  border-radius: 4px;
  overflow: hidden;
`;
const AiEditorFallback = styled__default.default.textarea`
  width: 100%;
  min-height: 360px;
  padding: 12px;
  border: 0;
...
const AceHtmlEditor = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(AiEditorShell, { children: [
    ...
    !aceReady ? /* @__PURE__ */ jsxRuntime.jsx(AiEditorFallback, { value, onChange: (event) => onChange(event.target.value) }) : null
  ] });
};
...
const JoditInput = ({
  ...
  const [aiButtons, setAiButtons] = react.useState([]);
  ...
  const closeAiModal = react.useCallback(() => {
    setAiModal({
      isOpen: false,
      status: "loading",
      content: ""
  ...
  const runAiClean = react.useCallback(async (button) => {
  ...
  const acceptAiContent = react.useCallback(() => {
    const jodit = editorRef.current;
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    designSystem.Field.Root,
    {
      ...
      children: [
        ...
        aiModal.isOpen ? /* @__PURE__ */ jsxRuntime.jsx(AiModalOverlay, { children: /* @__PURE__ */ jsxRuntime.jsxs(AiModalPanel, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(AiModalTitle, { children: aiModal.label || "AI clean" }),
          aiModal.status === "loading" ? /* @__PURE__ */ jsxRuntime.jsx(AiModalText, { children: "Ожидание ответа AI..." }) : null,
          aiModal.status === "error" ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
            /* @__PURE__ */ jsxRuntime.jsx(AiModalText, { children: aiModal.error || "Ошибка при выполнении AI clean" }),
            /* @__PURE__ */ jsxRuntime.jsx(AiModalActions, { children: /* @__PURE__ */ jsxRuntime.jsx(AiModalButton, { type: "button", onClick: closeAiModal, children: "Закрыть" }) })
          ] }) : null,
          aiModal.status === "review" ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              AceHtmlEditor,
              {
                value: aiModal.content,
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(AiModalActions, { children: [
              /* @__PURE__ */ jsxRuntime.jsx(AiModalButton, { type: "button", onClick: closeAiModal, children: "Отмена" }),
              /* @__PURE__ */ jsxRuntime.jsx(AiModalButton, { type: "button", "data-variant": "primary", onClick: acceptAiContent, children: "Принять" })
            ] })
          ] }) : null
        ] }) }) : null,
        /* @__PURE__ */ jsxRuntime.jsx(
