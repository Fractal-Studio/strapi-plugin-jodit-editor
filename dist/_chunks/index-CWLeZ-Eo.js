...
const index = {
  register(app) {
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () => Promise.resolve().then(() => require("./JoditInput-Dqza_ned.js")).then((module2) => ({ default: module2.default }))
      },
      options: {
        advanced: [
          {
...
exports.index = index;
//# sourceMappingURL=index-CWLeZ-Eo.js.map
